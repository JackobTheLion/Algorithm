 ...
 * <p>
 * -- ВРЕМЕННАЯ СЛОЖНОСТЬ --
 * Для выполнения алгоритма мы проходимся по каждому элементу массива один раз, поэтому сложность будет O(n), где n -
 * размер выражения, т.е. числа и арифметические операции.
 * <p>
