package ru.praktikum.yandex.sprint05.N;
...
public class Solution {
    ...
    private static List<Node> splitRec(Node root, int k, List<Node> result) {
        return null;
    }

    private static void balance(Node root) {
